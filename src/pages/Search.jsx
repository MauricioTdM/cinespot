            ...
            <div className="flex flex-col gap-8">
                ...
                <form className="flex justify-center" onSubmit={handleSearch}>
                    <div className="relative flex items-center">
                        ...
                        <input className="bg-[#1b1d22] border border-quaternary w-150 placeholder-gray-400 pl-12 pr-5 py-2 rounded-xl focus:outline-none focus:border-primary text-gray-400" type="text" placeholder="Buscar filme..." value={inputValue}
